...
export default function DoctorPatients() {
  ...
  const fetchData = async () => {
    try {
      ...
      const appointmentsData = apptSnapshot.docs.map((doc) => ({ id: doc.id, ...doc.data() }));
      ...
      <table className="patients-table">
        <thead>
          <tr>
            ...
            <th onClick={() => handleSort("sex")}>Sex{getSortIndicator("sex")}</th>
            <th onClick={() => handleSort("age")}>Age{getSortIndicator("age")}</th>
            <th onClick={() => handleSort("nextAppointment")}>Next Appointment{getSortIndicator("nextAppointment")}</th>
            <th onClick={() => handleSort("currentConcern")}>Current Concern{getSortIndicator("currentConcern")}</th>
          </tr>
        </thead>
        <tbody>
